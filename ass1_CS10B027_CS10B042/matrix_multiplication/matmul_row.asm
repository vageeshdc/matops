...
; This is the row major format .. same code except the way the multiplication is done 
...
mult_mat_2d:
	...
	; here this is the row major format
...
out_3_exit:
	...
	;writing result of C at necessary offset
	mov eax,[loop_i]
	imul eax,[j2]
	mov ebx,[loop_j]
	add eax,ebx
